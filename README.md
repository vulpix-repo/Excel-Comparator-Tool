...
python main.py
```
4. Once the GUI pops up, add the Excel files to compare. Select the reference column in both parts and the column to compare. Click on the compare button to begin.
5. 
